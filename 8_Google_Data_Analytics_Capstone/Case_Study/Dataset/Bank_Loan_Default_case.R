...
# REMOVING ALL THE OBJECTS STORED 
# Because R uses the RAm and to free-up space and increase 
#the speed of execution our program.
rm(list=ls(all=T))

#Set Working Directory 
setwd("E:/GoogleDataAnalytics/8_Google_Data_Analytics_Capstone/Case_Study/Dataset")

#Load Libraries
x = c("ggplot2", "corrgram", "DMwR", "caret", "randomForest", "unbalanced", "C50", "dummies", "e1071", "Information",
      "MASS", "rpart", "gbm", "ROSE", 'sampling', 'DataCombine','modeldata', 'inTrees')
...
#read cvs file
bank_loan = read.csv("bank_loan_analysis.csv", header = T, na.strings = c(" ", "", "NA"))

############################### Exploring the data #########################################################################

# It will Gives the structure: Arpit
str(bank_loan)
...
missing_val$Missing_percentage = (missing_val$Missing_percentage/nrow(bank_loan)) * 100
...
# kNN Imputation
bank_loan = DMwR::knnImputation(bank_loan, k = 3)
